  ...
  renderYearErrors() {
    ...
    if (numbers || this.state.year === "") {
      if (parseInt(this.state.year) < 1900 || parseInt(this.state.year) > 2019) {
        ...
        return(
          <span className="signup-error">Sorry, but you don't meet InMind's age requirements.</span>
        )
      }
    } else {
      return(
        ...
        <div className="signup-form">
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="signup-info">
              ...
              <div className="dob-msg">To sign up, you need to be at least 18. Other people who use InMind won’t see your birthday.</div>
              ...
              <div className="signup-options">
                ...
                <div className="signup-redirect">
                  <span className="yes-account">Already have an InMind account?</span>
